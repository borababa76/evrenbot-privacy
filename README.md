...
- Sunucu kanal bilgileri  
- Sunucu içerisindeki mesaj içerikleri  

---

### 2. Verilerin Kullanım Amacı

Toplanan veriler yalnızca şu amaçla kullanılır:

- Kullanıcılara daha iyi bir deneyim sunmak  
- Komutlara verilen yanıtları özelleştirmek  
- Destek ve yardım sistemlerini geliştirmek  
...
Verilerin güvenliği bizim için önemlidir. Yetkisiz erişime, veri kaybına veya kötüye kullanıma karşı teknik ve idari önlemler alınmıştır.
